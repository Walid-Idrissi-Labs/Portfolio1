  ...
  const cardStyle = useMemo(
    ...
    //   '--icon': "/dev_icon.png",
     '--icon': `url(/dev_icon_2.png)`,
      ...
      '--sunpillar-1': 'hsl(2, 100%, 30%)',
      '--sunpillar-2': 'hsl(53, 100%, 40%)',
      '--sunpillar-3': 'hsl(93, 100%, 60%)',
      '--sunpillar-4': 'hsl(176, 100%, 60%)',
      '--sunpillar-5': 'hsl(228, 100%, 40%)',
      '--sunpillar-6': 'hsl(283, 100%, 30%)',
    //   '--sunpillar-1': tailwindConfig.theme.extend.colors.beige_bright,
    //   '--sunpillar-2': tailwindConfig.theme.extend.colors.slate,
    //   '--sunpillar-3': tailwindConfig.theme.extend.colors.beige_dark, opacity : 0.8,
    //   '--sunpillar-4': tailwindConfig.theme.extend.colors.beige_bright, 
    //   '--sunpillar-5': tailwindConfig.theme.extend.colors.slate,
    //   '--sunpillar-6': tailwindConfig.theme.extend.colors.slate,
